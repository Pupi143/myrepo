...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['button'])) {
        ...
        if ($stmt->execute()) {
            echo "<script>alert('Reservation saved successfully!');</script>";
        } else {
            echo "<script>alert('Error saving reservation: " . addslashes($stmt->error) . "');</script>";
        }
        ...
        <div class="booking-form">
          ...
          <form method="POST" id="voice-recog-form">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <select class="form-control" name="room_type" id="rooms-input-field" onclick="startListeningRooms()" required>
