...
<body>
  ...
  <div class="landing-page">
    ...
    <div class="title-container">
      <div class="title">
          <h1>Premium Ocean Front Room</h1>
      </div>
  </div>

    <div class="row">
    <div class="col">
        <p>- Room Size: 573 sq. ft. to 666 sq. ft.</p>
        <p>- King bed</p>
        <p>- 49-inch LED TV</p>
        <p>- Netflix Subscribed TV</p>
        <p>- Washing & drying unit*</p>
        <p>- Complimentary Wi-Fi access</p>
        <p>- Extra bed services (with extra fee)</p>
        <p>- Free local call</p>
    </div>
    <div class="col">
        <img src="assets/pofr1.png">
    </div>
    </div>

    <div class="row">
        <div class="col">
            <img src="assets/pofr2.png">
        </div>
        <div class="col">
           <h2>&#8369;7800 / night</h2>
          ...
          <a href="room3.php" class="prev-button">&lHar;</a>
          <a href="room5.php" class="next-button">&rHar;</a>
          </div>
        </div>
        </div>
