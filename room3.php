...
<body>
  ...
  <div class="landing-page">
    ...
    <div class="title-container">
      <div class="title">
          <h1>Ocean Front Terrace</h1>
      </div>
  </div>

    <div class="row">
    <div class="col">
        <p>- Room Size: 386 sq. ft. to 489 sq. ft.</p>
        <p>- King bed</p>
        <p>- 49-inch LED TV</p>
    ...
    <div class="col">
        <img src="assets/oft1.png">
    </div>
    </div>

    <div class="row">
        <div class="col">
            <img src="assets/oft2.png">
        </div>
        <div class="col">
           <h2>&#8369;7000 / night</h2>
          ...
          <a href="room2.php" class="prev-button">&lHar;</a>
          <a href="room4.php" class="next-button">&rHar;</a>
          </div>
        </div>
        </div>
