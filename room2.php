...
<body>
  ...
  <div class="landing-page">
    ...
    <div class="title-container">
      <div class="title">
          <h1>Deluxe Terrace</h1>
      </div>
  </div>

    <div class="row">
    <div class="col">
        <p>- Room Size: 461 sq. ft. to 567 sq. ft.</p>
        <p>- King / Queen bed*</p>
        <p>- 49-inch LED TV</p>
    ...
    <div class="col">
        <img src="assets/deluxe1.png">
    </div>
    </div>

    <div class="row">
        <div class="col">
            <img src="assets/superior2.jpg">
        </div>
        <div class="col">
          <h2>&#8369;6000 / night</h2>
         ...
         <div class="navigation-buttons">
          <a href="room1.php" class="prev-button">&lHar;</a>
          <a href="room3.php" class="next-button">&rHar;</a>
          </div>
       </div>
       </div>
